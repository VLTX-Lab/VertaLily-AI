...
# The Oracle's Absence: VOID Paper

## Paper Files

| File | Description |
|------|-------------|
| [`paper/paper.pdf`](paper/void_paper.pdf) | Complete paper (PDF format) |
...
If you use VertaLily in your research or product, please cite:
...
@techreport{adimulya2026void,
    ...
    day = {14},
    version = {1.0.10},
    url = {https://github.com/VLTX-Lab/vertalily-void/blob/main/paper/paper.pdf}
}
```
